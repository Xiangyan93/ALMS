...
def get_kernel_config(args: KernelArgs, dataset: Dataset,
    ...
    if args.graph_kernel_type is None:
        ...
        from alms.ml.mgk.kernels.BaseKernelConfig import BaseKernelConfig
        ...
        from alms.ml.mgk.kernels.GraphKernel import GraphKernelConfig
        ...
        from alms.ml.mgk.kernels.PreCalcKernel import PreCalcKernelConfig
