...
def get_kernel_config(args: KernelArgs, dataset: Dataset,
    ...
    if args.graph_kernel_type is None:
        ...
        from aims.ml.mgk.kernels.BaseKernelConfig import BaseKernelConfig
        ...
        from aims.ml.mgk.kernels.GraphKernel import GraphKernelConfig
        ...
        from aims.ml.mgk.kernels.PreCalcKernel import PreCalcKernelConfig
