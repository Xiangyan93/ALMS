...
from aims.ml.chemprop.features import load_features, load_valid_atom_or_bond_features
...
def get_data(path: str,
    ...
    with open(path) as f:
        ...
        data = MoleculeDataset(Parallel(
                n_jobs=args.num_workers, verbose=True,
            ...
            delayed(MoleculeDatapoint)(
                ...
                atom_descriptors=atom_descriptors[
                    i] if atom_descriptors is not None else None,
                bond_features=bond_features[
                    i] if bond_features is not None else None,
