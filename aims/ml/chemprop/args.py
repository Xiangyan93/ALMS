...
import aims.ml.chemprop.data.utils
from aims.ml.chemprop.data import set_cache_mol, empty_cache
from aims.ml.chemprop.features import get_available_features_generators
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        self.smiles_columns = aims.ml.chemprop.data.utils.preprocess_smiles_columns(
            path=self.data_path,
